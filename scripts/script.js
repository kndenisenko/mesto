// * вот без этого не заработает ничего
...
// * попап, кнокпи его открытия и закрытия
...
// * поиск имени и профессии в HTML-разметке
let username = document.querySelector('.profile__name');
let occupation = document.querySelector('.profile__occupation');

// * поиск полей имени и профессии в попапе
let nameField = document.getElementById('username');
let occupationField = document.getElementById('occupation');

// * функция открытия и закрытия попапа, без сохранения изменний
function popupOpen() {
